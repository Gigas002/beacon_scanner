...
class BeaconScannerIOS extends BeaconScannerPlatform {
  ...
  static void registerWith() => BeaconScannerPlatform.instance = BeaconScannerIOS();
  ...
  @override
  Future<bool?> setScanPeriod(int scanPeriod) => Future.value(true);

  @override
  Future<bool?> setBetweenScanPeriod(int betweenScanPeriod) => Future.value(true);
}
